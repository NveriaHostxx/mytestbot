...
if (message.author.id !== '390636399340027906') return message.reply('** هذا الأمر فقط لصاحب البوت و شكراًً **')
...
client.on('message', MohamedTarek => {
var prefix = "#";
